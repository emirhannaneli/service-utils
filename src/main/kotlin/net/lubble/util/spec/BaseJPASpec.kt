 ...
 */
abstract class BaseJPASpec<T : BaseJPAModel>(params: ParameterModel, val fields: Collection<String>? = null) : SpecTool(params),
    SpecTool.JPAModel<T> {
    fun toKey(): String {
 ...
 * @param fields the fields to projection
 */
abstract class BaseMongoSpec<T : BaseMongoModel>(params: ParameterModel, val fields: Collection<String>? = null) : SpecTool(params),
